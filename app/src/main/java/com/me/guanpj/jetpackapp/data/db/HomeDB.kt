...
package com.me.guanpj.jetpackapp.data.bean.db
...
import com.me.guanpj.jetpackapp.data.Converters
import com.me.guanpj.jetpackapp.data.bean.Component
import com.me.guanpj.jetpackapp.data.db.HomeDao
import com.me.guanpj.jetpackapp.workers.SeedDatabaseWorker
...
abstract class HomeDB : RoomDatabase() {
    ...
    companion object {
        ...
        private fun buildDatabase(context: Context): HomeDB {
            return Room.databaseBuilder(context, HomeDB::class.java, Constants.DATABASE_NAME)
